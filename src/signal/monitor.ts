...
export async function monitorSignalProvider(opts: MonitorSignalOpts = {}): Promise<void> {
  ...
  try {
    ...
    const handleEvent = createSignalEventHandler({
      ...
      reactionMode,
      reactionAllowlist,
      reactionDelivery: accountInfo.config.reactionDelivery,
      reactionBundleWindowMs: accountInfo.config.reactionBundleWindowMs,
      reactionIncludeMessage: accountInfo.config.reactionIncludeMessage,
      mediaMaxBytes,
      ignoreAttachments,
      sendReadReceipts,
